...
export function chartRoutes() {
  ...
  r.get('/', requireAuth, requirePolicies, requireGoodStanding, (c) => c.json(getChart(c.get('ctx'))));
  r.put('/my-shore', requireAuth, requirePolicies, requireGoodStanding, jsonBody(SetShoreRequestSchema), (c) => {
