...
//
//   • Nights follow the same day/night convention as the map (DAYLIGHT_DEFAULTS), evaluated in
//     the server's configured zone. A night is keyed by the local date it starts on.
